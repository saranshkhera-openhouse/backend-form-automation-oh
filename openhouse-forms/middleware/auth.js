...
const ROUTE_FORM_MAP = {
  ...
  '/token-deal': 'token-deal', '/ama-details': 'ama-details', '/final': 'final', '/cp-bill': 'cp-bill', '/listing': 'listing'
};
const API_FORM_MAP = {
  '/api/schedule': 'schedule', '/api/visit': 'visit', '/api/token-request': 'token-request',
  '/api/token-deal': 'token-deal', '/api/ama-details': 'ama-details', '/api/final': 'final', '/api/cp-bill': 'cp-bill', '/api/listing': 'listing'
};
