...
CREATE TABLE IF NOT EXISTS properties (
  ...
  rent_payable_period             TEXT,
  rent_payable_grace_period       TEXT,
...
BEGIN
  ...
  END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='properties' AND column_name='rent_payable_period') THEN
    ALTER TABLE properties ADD COLUMN rent_payable_period TEXT;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='properties' AND column_name='rent_payable_grace_period') THEN
    ALTER TABLE properties ADD COLUMN rent_payable_grace_period TEXT;
  END IF;
END
$$;
`;
